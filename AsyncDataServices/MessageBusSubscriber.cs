...
namespace Micro.CommandsService.AsyncDataServices
{
    public class MessageBusSubscriber : BackgroundService // Can be only inject Singleton type services our EventProcessor is singleton so its ok.
    {
